...
class DetailView: UIView,UIScrollViewDelegate{
    ...
    */
    ...
    override init(frame: CGRect) {
        ...
        segPrio.addTarget(self.superview, action: #selector(DetailViewController.changePrio(sender:)), for: UIControlEvents.valueChanged)
       // segPrio.addTarget(super.superview, action: #selector(DetailViewController.changePrio(sender:)), for: UIControlEvents.touchDown)
        ...
        tf.addTarget(super.superview, action: #selector(DetailViewController.changeText(sender:)), for: .allEditingEvents)
